...
The github repository including the code used to perform the analysis and additional figures describing the fit of the models to the data can be found at: https://github.com/szuwalski/snow_confounded.
...
LikeNames<-read.csv(paste("data/LikelihoodComponentNames.txt",sep=""),header=F)
...
LikeForm<-read.csv(paste("data/Likelihood components and weightings.csv",sep=""),header=T)
